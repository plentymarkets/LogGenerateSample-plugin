...
# my  Hello World plugin is the best

ästätißsche pö lllll

This is the **Hello World** plugin developeddd by plentymarkets.
...
For detailed information about pludgin provisioning refer to [plentymarkets developers](https://developers.plentymarkets.com/dev-doc/basics#plugin-provisioning).
